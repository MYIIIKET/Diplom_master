function [sM,sTrain] = som_prototrain(sM, D, epoch)
...
% training length
trainlen = epoch*dlen; % 20 epochs by default
...
for t = 1:trainlen, 
  ...
  dist2_1 = sort(dist2);
  minInd = 1;
  bmu = find(dist2(:,1)==dist2_1(minInd,1), 1);            % find BMU
  for i = 1:munits
